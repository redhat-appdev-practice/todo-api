...
public class OpenAPIDocumentationConfig {
    ...
    @Bean
    public Docket customImplementation(ServletContext servletContext, @Value("${openapi.todo.base-path:/api/v1}") String basePath) {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                    .apis(RequestHandlerSelectors.basePackage("com.redhat.openapi.todo.api"))
                    .build()
